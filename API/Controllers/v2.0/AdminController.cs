...
namespace API.Controllers.v2_0
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(AppDbContext context, UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, ILogger<AdminController> logger,
            ...
            IUserValidator<AppUser> userValidator, IControllerSubModulesV2 subModule, IValidateV2 validate, IOptions<EmailConfigV2> emailConfig, IEmailServiceV2 email, IMyMFA MyMFA)
        {
            _context = context;
            ...
            try
            {
                ...
                if (passValidation == 0)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        // MFA
                        user.EnableMFA = request.EnableMFA;
            ...
            try
            {
                ...
                if (passValidation == 0)
                {
                    ...
                    var user = new AppUser
                    {
                        ...
                        EnableMFA = true                            // Admins always have MFA enabled by default.
                    };
