...
{
    public class ControllerSubModulesV1 : IControllerSubModulesV1
    {
        // SUB-MODULES
        ...
        private readonly ILogger<ControllerSubModulesV1> _logger;
        ...
        public ControllerSubModulesV1(AppDbContext context, UserManager<AppUser> userManager, ILogger<ControllerSubModulesV1> logger,
            IOptions<JwtBearerTokenSettings> jwtTokenOptions, IOptions<EmailConfigV1> emailConfig, IEmailServiceV1 email)
        {
            _context = context;
        ...
        public async Task<AppUser> GetUserByEmailOrUserNameAndVerifyPassword(UserLoginDto credentials)
        {
            try
            {
                ...
                if (user != null)
                {
                    ...
                    // If the Password verification failed, return null. If it succeded, return the user object.
        ...
        public async Task<RefreshTokenTable> GenerateRefreshToken(AppUser user, string? refreshToken = null)
        {
            ...
            await _context.RefreshTokenTable.AddAsync(newRefreshToken);
