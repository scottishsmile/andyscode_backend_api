...
{
    public class NewsletterV1 : INewsletterV1
    {
        ...
        private readonly ILogger<NewsletterV1> _logger;
        private readonly IOptions<SendInBlueConfigV1> _sibConfig;             // Get appsettings.json configs

        public NewsletterV1(ILogger<NewsletterV1> logger, IOptions<SendInBlueConfigV1> sibConfig)
        {
            _logger = logger;
