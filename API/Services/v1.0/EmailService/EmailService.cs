...
{
    public class EmailServiceV1 : IEmailServiceV1
    {

        private readonly ILogger<EmailServiceV1> _logger;
        private readonly IOptions<EmailConfigV1> _emailConfig;                            // EmailConfiguration settings in appsettings.json

        // Constructor
        public EmailServiceV1(IOptions<EmailConfigV1> emailConfig, ILogger<EmailServiceV1>  logger)
        {
